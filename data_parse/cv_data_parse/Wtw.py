...
class Loader(DataLoader):
    ...
    def _call(self, set_type=DataRegister.TRAIN, **kwargs):
        ...
        gen_func = Path(f'{root_dir}/xml').glob('*.xml')
        return self.gen_data(gen_func, root_dir=root_dir, **kwargs)

    def get_ret(self, xml_file, image_type=DataRegister.PATH, root_dir='', **kwargs) -> dict:
